...
| 橫式商品卡           | momo 店取與今日暢銷榜共用：335 × 174、padding 16px、圖 140 × 140 在左、圖文間距 10px；促銷文字 13 / 18 `sale` 單行；名稱 15 / 20 兩行；價格 21px / 700 `price`，原價在**同一列**右側；卡片間距約 10px，可見約 3.45 張                                                                                                                                                                                   |
...
| 首頁的頁面與區塊     | 頁面底色 `surface-muted`（`#f2f2f2`）滿版；每個區塊是 1220px 寬的白色區帶，內容四周 padding 16px（內容寬 1188px）；旗艦名店與超大牌例外，圖片貼齊 1220px、沒有間距（3 × 406、4 × 305）                                                                                                                                                                                                                  |
