...
`type:feature · scope:shell`

Application chrome shared by every page: sticky top bar (compact on scroll), main header, expandable category navigation and footer. Exposes a single `ShellLayout`.
